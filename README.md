...
_Author: Prince Jaiswal_  
_Last update: 23/02/2024_  

This repository corresponds to the source code used for the Advanced Security project "__Cyber Attack Detection in industry all thanks to Machine Learning Algorithms__". This work has been carried out by Prince Jaiswal,chinmay kini,faizan jameel,mohammad khalid.  

## Method description
The aim of the project is to find a mechanism that can detect cyber attacks by analysing flows in a network. To do this, a benchmark of different machine learning methods is performed on a large netflow dataset.
